...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static final String START_MESSAGE = "Find as many words as possible that can be formed by adding one or two letter(s) to <big>%s</big> (but that do not contain the substring %s).";
